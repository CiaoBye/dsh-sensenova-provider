...
// every /api/accountPool/* route). Skips when the loader is absent.
...
test('the host manifest passes the real typert-loader validation', async (t) => {
  ...
  const validated = validateTypertManifest('dsh-account-pool', TYPERT)
  assert.equal(validated.package, 'dsh-account-pool')
